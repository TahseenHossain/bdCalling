const NavBar = () => {
  return (
    <div className='lg:px-24 pt-4'>
      <div className="navbar bg-gradient-to-r from-[#591BFF] to-[#7B4AFFAB] rounded-[20px]">
        <div className="navbar-start px-6">
          ...
          <a className="btn btn-ghost text-xl">
            <img src="https://i.ibb.co/Qr957Hh/Event-Host.png" alt="" />
          </a>
        </div>
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <div className="indicator">
                <svg
                  xmlns="https://i.ibb.co/m6LV7xd/Group-7.png"
